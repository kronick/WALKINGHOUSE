...
void configMenu() {
  ...
  GUI.clearElements();
  Button calibrateButton = new Button(new XY(width/2, 250), 300, 50, "CALIBRATE", new Action() { public void act(float x, float y) { house.calibrate = true; calibrateMenu(ALL_ACTS); } } ); 
  Button moveLegButton = new Button(new XY(width/2, 300), 300, 50, "MOVE LEG", new Action() { public void act(float x, float y) { house.calibrate = true; calibrateMenu(SINGLE_LEG); } } ); 
  Button stepheightButton = new Button(new XY(width/2, 150), 300, 50, "STEP HEIGHT", new Action() { public void act(float x, float y) { stepHeightMenu(); } } );
  Button gaitButton = new Button(new XY(width/2, 100), 300, 50, "GAIT", new Action() { public void act(float x, float y) { gaitMenu(); } } );
 
  Button exitButton = new Button(new XY(width/2, 400), 300, 50, "EXIT", new Action() { public void act(float x, float y) { exit(); } } ); 
...
void gaitMenu() {
    GUI.clearElements();
    Button tripodButton = new Button(new XY(width/2, 150), 300, 50, "TRIPOD", new Action() { public void act(float x, float y) { house.gait = house.TRIPOD_GAIT; house.gaitState = 0; } } ); 
    Button waveButton = new Button(new XY(width/2, 200), 300, 50, "WAVE", new Action() { public void act(float x, float y) { house.gait = house.WAVE_GAIT; house.gaitState = 0; } } ); 
...
void stepHeightMenu() {
    ...
    Button highButton = new Button(new XY(3*(width-80)/4, 30), 230, 40, "HIGH", new Action() { public void act(float x, float y) { house.footUpLevel = 42; house.footDownLevel = 61.5; } });  
...
void calibrateMenu(int mode) {
  ...
  if(calibrateMode == SINGLE_ACT || calibrateMode == SINGLE_LEG) {
    ...
    GUI.clickables.add(backButton);     
      ...
      sliders[00] = new VSlider(30, height*.65, -1000, 1000, 20 + 00*(width-80)/18., height/2, new SliderAction() { public void act(float value) { setPosition(0,0, int(value)); } });
      sliders[01] = new VSlider(30, height*.65, -1000, 1000, 20 + 01*(width-80)/18., height/2, new SliderAction() { public void act(float value) { setPosition(0,1, int(value)); } });
      sliders[02] = new VSlider(30, height*.65, -2000, 2000, 20 + 02*(width-80)/18., height/2, new SliderAction() { public void act(float value) { setPosition(0,2, int(value)); } });
      sliders[03] = new VSlider(30, height*.65, -1000, 1000, 20 + 03*(width-80)/18., height/2, new SliderAction() { public void act(float value) { setPosition(0,3, int(value)); } });
      sliders[04] = new VSlider(30, height*.65, -1000, 1000, 20 + 04*(width-80)/18., height/2, new SliderAction() { public void act(float value) { setPosition(0,4, int(value)); } });
      sliders[05] = new VSlider(30, height*.65, -2000, 2000, 20 + 05*(width-80)/18., height/2, new SliderAction() { public void act(float value) { setPosition(0,5, int(value)); } });
      sliders[06] = new VSlider(30, height*.65, -1000, 1000, 20 + 06*(width-80)/18., height/2, new SliderAction() { public void act(float value) { setPosition(1,0, int(value)); } });
      sliders[07] = new VSlider(30, height*.65, -1000, 1000, 20 + 07*(width-80)/18., height/2, new SliderAction() { public void act(float value) { setPosition(1,1, int(value)); } });
      sliders[8]  = new VSlider(30, height*.65, -2000, 2000, 20 +  8*(width-80)/18., height/2, new SliderAction() { public void act(float value) { setPosition(1,2, int(value)); } });
      sliders[9]  = new VSlider(30, height*.65, -1000, 1000, 20 +  9*(width-80)/18., height/2, new SliderAction() { public void act(float value) { setPosition(1,3, int(value)); } });
      sliders[10] = new VSlider(30, height*.65, -1000, 1000, 20 + 10*(width-80)/18., height/2, new SliderAction() { public void act(float value) { setPosition(1,4, int(value)); } });
      sliders[11] = new VSlider(30, height*.65, -2000, 2000, 20 + 11*(width-80)/18., height/2, new SliderAction() { public void act(float value) { setPosition(1,5, int(value)); } });
      sliders[12] = new VSlider(30, height*.65, -1000, 1000, 20 + 12*(width-80)/18., height/2, new SliderAction() { public void act(float value) { setPosition(2,0, int(value)); } });
      sliders[13] = new VSlider(30, height*.65, -1000, 1000, 20 + 13*(width-80)/18., height/2, new SliderAction() { public void act(float value) { setPosition(2,1, int(value)); } });
      sliders[14] = new VSlider(30, height*.65, -2000, 2000, 20 + 14*(width-80)/18., height/2, new SliderAction() { public void act(float value) { setPosition(2,2, int(value)); } });
      sliders[15] = new VSlider(30, height*.65, -1000, 1000, 20 + 15*(width-80)/18., height/2, new SliderAction() { public void act(float value) { setPosition(2,3, int(value)); } });
      sliders[16] = new VSlider(30, height*.65, -1000, 1000, 20 + 16*(width-80)/18., height/2, new SliderAction() { public void act(float value) { setPosition(2,4, int(value)); } });
      sliders[17] = new VSlider(30, height*.65, -2000, 2000, 20 + 17*(width-80)/18., height/2, new SliderAction() { public void act(float value) { setPosition(2,5, int(value)); } });  
      
      buttons[00] = new Button(new XY(20 + 00*(width-80)/18., 30), 40, 40, "C", new Action() { public void act(float x, float y) { calibrate(0,0); } });
      buttons[01] = new Button(new XY(20 + 01*(width-80)/18., 30), 40, 40, "C", new Action() { public void act(float x, float y) { calibrate(0,1); } });
      buttons[02] = new Button(new XY(20 + 02*(width-80)/18., 30), 40, 40, "C", new Action() { public void act(float x, float y) { calibrate(0,2); } });
      buttons[03] = new Button(new XY(20 + 03*(width-80)/18., 30), 40, 40, "C", new Action() { public void act(float x, float y) { calibrate(0,3); } });
      buttons[04] = new Button(new XY(20 + 04*(width-80)/18., 30), 40, 40, "C", new Action() { public void act(float x, float y) { calibrate(0,4); } });
      buttons[05] = new Button(new XY(20 + 05*(width-80)/18., 30), 40, 40, "C", new Action() { public void act(float x, float y) { calibrate(0,5); } });
      buttons[06] = new Button(new XY(20 + 06*(width-80)/18., 30), 40, 40, "C", new Action() { public void act(float x, float y) { calibrate(1,0); } });
      buttons[07] = new Button(new XY(20 + 07*(width-80)/18., 30), 40, 40, "C", new Action() { public void act(float x, float y) { calibrate(1,1); } });
      buttons[8]  = new Button(new XY(20 + 8*(width-80)/18., 30), 40, 40, "C", new Action() { public void act(float x, float y) { calibrate(1,2); } });
      buttons[9]  = new Button(new XY(20 + 9*(width-80)/18., 30), 40, 40, "C", new Action() { public void act(float x, float y) { calibrate(1,3); } });
      buttons[10] = new Button(new XY(20 + 10*(width-80)/18., 30), 40, 40, "C", new Action() { public void act(float x, float y) { calibrate(1,4); } });
      buttons[11] = new Button(new XY(20 + 11*(width-80)/18., 30), 40, 40, "C", new Action() { public void act(float x, float y) { calibrate(1,5); } });
      buttons[12] = new Button(new XY(20 + 12*(width-80)/18., 30), 40, 40, "C", new Action() { public void act(float x, float y) { calibrate(2,0); } });
      buttons[13] = new Button(new XY(20 + 13*(width-80)/18., 30), 40, 40, "C", new Action() { public void act(float x, float y) { calibrate(2,1); } });
      buttons[14] = new Button(new XY(20 + 14*(width-80)/18., 30), 40, 40, "C", new Action() { public void act(float x, float y) { calibrate(2,2); } });
      buttons[15] = new Button(new XY(20 + 15*(width-80)/18., 30), 40, 40, "C", new Action() { public void act(float x, float y) { calibrate(2,3); } });
      buttons[16] = new Button(new XY(20 + 16*(width-80)/18., 30), 40, 40, "C", new Action() { public void act(float x, float y) { calibrate(2,4); } });
      buttons[17] = new Button(new XY(20 + 17*(width-80)/18., 30), 40, 40, "C", new Action() { public void act(float x, float y) { calibrate(2,5); } });  
...
void statsMenu() {
  ...
  Button resetButton = new Button(new XY(100, 25), 200, 50, "RESET", new Action() { public void act(float x, float y) { info.resetAvgCurrent(); } });
...
void addMapNavIcons() {
  ...
  Button zoominButton = new Button(new XY(50, 350), "icons/zoomin.svg", new Action() { public void act(float x, float y) { zoom *= 1.1; } });
  Button zoomoutButton = new Button(new XY(130, 350), "icons/zoomout.svg", new Action() { public void act(float x, float y) { zoom *= .9; } });     
