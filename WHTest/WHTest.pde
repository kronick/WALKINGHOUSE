...
void buildSliders() {
  ...
  sliders[02] = new VSlider(30, height*.75, -2000, 2000, 35 + 02*width/19., height/2, new SliderAction() { void act(float value) { setPosition(0,2, int(value)); } });
  ...
  sliders[05] = new VSlider(30, height*.75, -2000, 2000, 35 + 05*width/19., height/2, new SliderAction() { void act(float value) { setPosition(0,5, int(value)); } });
  ...
  sliders[8]  = new VSlider(30, height*.75, -2000, 2000, 35 +  8*width/19., height/2, new SliderAction() { void act(float value) { setPosition(1,2, int(value)); } });
  ...
  sliders[11] = new VSlider(30, height*.75, -2000, 2000, 35 + 11*width/19., height/2, new SliderAction() { void act(float value) { setPosition(1,5, int(value)); } });
  ...
  sliders[14] = new VSlider(30, height*.75, -2000, 2000, 35 + 14*width/19., height/2, new SliderAction() { void act(float value) { setPosition(2,2, int(value)); } });
  ...
  sliders[17] = new VSlider(30, height*.75, -2000, 2000, 35 + 17*width/19., height/2, new SliderAction() { void act(float value) { setPosition(2,5, int(value)); } });  
